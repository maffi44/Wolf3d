...
int		main(int argc, char **argv)
{
	...
	insts[0] = make_obj_inst_new(ref_objs, make_vec(0.1, 0.1, 0.1), make_vec(2, 3, 3));
	insts[1] = make_obj_inst_new(ref_objs, make_vec(0.1, 0.1, 0.3), make_vec(-2, 3, 5));
	insts[2] = make_obj_inst_new(ref_objs, make_vec(0.1, 0.4, 0.2), make_vec(1, 1, 1));
	data->obj_inst = insts;
	data->num_of_inst_objects = 3;
